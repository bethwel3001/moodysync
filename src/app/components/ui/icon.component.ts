...
// We'll use inline SVGs or a different icon library
...
@Component({
  ...
  template: `
    <span [innerHTML]="selectedIcon" class="inline-block"></span>
  `
})
export class IconComponent {
  @Input() name: string = 'music';
  
  get selectedIcon() {
    return icons[this.name] || icons['music'];
  }
}